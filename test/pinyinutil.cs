...
namespace test
{
    class pinyinutil
    {
        public static string pinyinheader =
    ...
    + "XY";
        //public static string GetFristLetter(string strText)
        //{
        ...
        //            myStr.Append(pinyinheader[(int)vChar - 19968]);
        //        else
        ...
        public static string GetFristLetter(string hz)
        {
            ...
            for (int i = 0; i < hz.Length; i++)
            {
                ...
                {
                    string wordTemp = getSpellFromLevelOne(word);
                    //若一级字符转换失败，则进行二级字库比对。
                    if (!"*".Equals(wordTemp))
                    {
                        return_py += wordTemp;
                    ...
                    {
                        return_py += getSpellFromLevelTwo(word);
                    }
                }
            ...
            return return_py.ToUpper();//转成小写字母
        }
        ///
        /// 用来获得一个字的拼音首字母，一级字库
        ///
        ///
        ///
        public static string getSpellFromLevelOne(string cnChar)
        {
            //将汉字转化为ASNI码,二进制序列
        ...
        ///
        ///
        public static string getSpellFromLevelTwo(string cnChar)
        {
    ...
    "ALBXYFBPNLSFHTGJWEJJXXGLLJSTGSHJQLZFKCGNNDSZFDEQFHBSAQTGLLBXMMYGSZLDYDQMJJRGBJTKGDHGKBLQKBDMBYLXWCXYTTYBKMRTJZXQJBHLMHMJJZMQASLDCYXYQDLQCAFYWYXQHZ";
            ...
            int Flag = ls_second_ch.IndexOf(cnChar, 0);
            if (Flag != -1)
            {
                return ls_second_eng.Substring(Flag, 1);
            }
            else
            {
                return "*";
